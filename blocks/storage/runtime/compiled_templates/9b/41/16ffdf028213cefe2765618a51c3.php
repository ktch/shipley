...
/*  */
class __TwigTemplate_9b4116ffdf028213cefe2765618a51c3 extends Twig_Template
{
...
\t\t\t<div class=\"eight columns\">
                ";
        // line 90
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "storyLeft"), "html", null, true);
        echo "
\t\t\t</div> 
\t\t\t
\t\t\t<div class=\"eight columns\">
                ";
        // line 94
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "storyRight"), "html", null, true);
        echo "
\t\t\t</div>
\t\t\t
\t\t\t<div class=\"clear\"></div>
...
\t\t<div class=\"bg2\"></div>
        <p class=\"separator\">";
        // line 107
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "gap1"), "html", null, true);
        echo "</p>
\t</div>
\t
\t
...
\t\t\t<div class=\"eight columns\">
                ";
        // line 121
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "planLeft"), "html", null, true);
        echo "
\t\t\t</div> 
\t\t\t
\t\t\t<div class=\"eight columns\">
                ";
        // line 125
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "planRight"), "html", null, true);
        echo "
\t\t\t</div>
\t\t\t
\t\t\t<div class=\"clear\"></div>
...
\t\t\t\t<div class=\"one-third column\">
                    <h4>";
        // line 132
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "step1Heading"), "html", null, true);
        echo "</h4>
\t\t\t\t\t<img src=\"\" alt=\"\" />
                    <p class=\"white\">";
        // line 134
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "step1"), "html", null, true);
        echo "</p>
\t\t\t\t</div>
\t\t\t\t
\t\t\t\t<div class=\"one-third column\">
                    <h4>";
        // line 138
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "step2Heading"), "html", null, true);
        echo "</h4>
\t\t\t\t\t<img src=\"\" alt=\"\" />
                    <p class=\"white\">";
        // line 140
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "step2"), "html", null, true);
        echo "</p>
\t\t\t\t</div>
\t\t\t\t
\t\t\t\t<div class=\"one-third column\">
                    <h4>";
        // line 144
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "step3Heading"), "html", null, true);
        echo "</h4>
\t\t\t\t\t<img src=\"\" alt=\"\" />
                    <p class=\"white\">";
        // line 146
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "step3"), "html", null, true);
        echo "</p>
\t\t\t\t</div>
\t\t\t</div> <!-- end serv-list -->
\t\t\t
...
\t\t<div class=\"bg3\"></div>
        <p class=\"separator\">";
        // line 158
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "globals"), "gap2"), "html", null, true);
        echo "</p>
\t</div>
\t
\t
...
\t\t\t
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "blx"), "entries"), "section", array(0 => "team"), "method"), "find", array(), "method"));
        foreach ($context['_seq'] as $context["_key"] => $context["member"]) {
            ...
            echo "\t\t\t\t<div class=\"one-third column\">
                    ...
                    <p class=\"t-name\">";
            // line 175
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "member"), "title"), "html", null, true);
            echo "</p>
                    <p class=\"t-type\">";
            // line 176
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "member"), "job"), "html", null, true);
            echo "</p>
\t\t\t\t\t<!-- <ul>
...
\t\t\t\t\t\t\t\t\t\t</ul> -->
                    <p>";
            // line 181
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "member"), "description"), "html", null, true);
            echo "</p>
...
";
    ...
    {
        return array (  257 => 184,  248 => 181,  240 => 176,  236 => 175,  232 => 173,  228 => 172,  211 => 158,  196 => 146,  191 => 144,  184 => 140,  179 => 138,  172 => 134,  167 => 132,  157 => 125,  150 => 121,  133 => 107,  117 => 94,  110 => 90,  19 => 1,);
    }
}
