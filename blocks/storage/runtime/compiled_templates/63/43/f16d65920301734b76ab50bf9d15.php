...
/* dashboard */
class __TwigTemplate_6343f16d65920301734b76ab50bf9d15 extends Twig_Template
{
...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["blx"]) ? $context["blx"] : $this->getContext($context, "blx")), "dashboard"), "getUserWidgets"));
...
\t\t\t\t\t\t";
                // line 23
                echo $this->getAttribute((isset($context["widgetType"]) ? $context["widgetType"] : $this->getContext($context, "widgetType")), "getBodyHtml");
                echo "
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t";
