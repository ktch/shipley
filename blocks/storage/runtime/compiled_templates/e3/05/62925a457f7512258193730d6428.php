...
/* content/_layout */
class __TwigTemplate_e30562925a457f7512258193730d6428 extends Twig_Template
{
    ...
    {
        // line 2
        $context["totalGlobals"] = (($this->getAttribute($this->getContext($context, "user"), "can", array(0 => "editGlobals"), "method")) ? ($this->getAttribute($this->getAttribute($this->getContext($context, "blx"), "globals"), "getTotalBlocks")) : (0));
        // line 5
        ob_start();
        // line 6
        echo "\t<h1>";
...
";
        ...
        // line 11
        echo "\t<li><a";
        if (($this->getContext($context, "tab") == "entries")) {
            echo " class=\"active\"";
        }
        echo " href=\"";
...
\t<li><a";
        // line 12
        if (($this->getContext($context, "tab") == "pages")) {
            echo " class=\"active\"";
        }
        echo " href=\"";
...
\t";
        // line 13
        if ($this->getContext($context, "totalGlobals")) {
            echo "<li><a";
            if (($this->getContext($context, "tab") == "globals")) {
                echo " class=\"active\"";
            }
            echo " href=\"";
